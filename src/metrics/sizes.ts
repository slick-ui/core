...
export { scaleSize };
export const SIZE_574 = scaleSize(574);
export const SIZE_400 = scaleSize(400);
export const SIZE_360 = scaleSize(360);
export const SIZE_364 = scaleSize(364);
...
export const SIZE_185 = scaleSize(185);
...
export const SIZE_110 = scaleSize(110);
...
export const SIZE_68 = scaleSize(68);
...
export const BUTTON_HEIGHT = SIZE_60;
export const RADIUS = SIZE_30;
